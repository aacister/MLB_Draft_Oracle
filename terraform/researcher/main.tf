...
resource "aws_iam_role" "app_runner_role" {
  name = "mlbdraftoracle-app-runner-role"
...
resource "aws_iam_role" "app_runner_instance_role" {
  name = "mlbdraftoracle-app-runner-instance-role"
...
resource "aws_iam_role_policy" "app_runner_instance_bedrock_access" {
  name = "mlbdraftoracle-app-runner-instance-bedrock-policy"
...
resource "aws_apprunner_service" "researcher" {
  service_name = "mlbdraftoracle-researcher"
...
resource "aws_iam_role" "eventbridge_role" {
  ...
  name  = "mlbdraftoracle-eventbridge-scheduler-role"
...
resource "aws_lambda_function" "scheduler_lambda" {
  count         = var.scheduler_enabled ? 1 : 0
  function_name = "mlbdraftoracle-researcher-scheduler"
...
resource "aws_iam_role" "lambda_scheduler_role" {
  count = var.scheduler_enabled ? 1 : 0
  name  = "mlbdraftoracle-scheduler-lambda-role"
...
resource "aws_scheduler_schedule" "research_schedule" {
  count = var.scheduler_enabled ? 1 : 0
  name  = "mlbdraftoracle-research-schedule"
